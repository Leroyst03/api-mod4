...
public class ServicioProducto {
    ...
    public Producto updateProducto(Long id, Producto nuevoProducto) {
        ...
        if(nuevoProducto.getCantidad() != null) producto.setCantidad(nuevoProducto.getCantidad());
        if(nuevoProducto.getPrecio() != producto.getPrecio()) producto.setPrecio(nuevoProducto.getPrecio());
